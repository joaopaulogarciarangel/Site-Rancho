          ...
          {Array.from({ length: 10 }, (_, i) => i + 1).map((numero) => {
            ...
            return (
              <div
                ...
                className={`cursor-pointer touch-manipulation select-none border-2 rounded-2xl py-8 flex flex-col items-center justify-center shadow-sm transition-all relative
              ...
              >
                {mesaOcupada && !aguardandoPagamento && <div className="absolute top-3 right-3 w-3 h-3 bg-orange-600 rounded-full animate-pulse"></div>}
